...
var mycrtl1 = myapp1.controller('myCtrl', function ($scope, $http, $localStorage, $uibModal, $filter)
{
    ...
    //$scope.selected = $scope.parseLocation(window.location.search)['id'];
    //$scope.message = "ajay";
    $scope.init = function () {
        ...
        //            $scope.selected = $scope.CardsList[0].Id;
        //            return;
        //        }
        //    }
        //    else
        ...
        ////    }
            ...
            $scope.saveCardDetails = function (currCard)
            {
               ...
               // CardName
                ...
                {
                    alert('Please select cardnumber .');
                    return;
                }
                //CVV1
                if (newCard.CVV == null) {
                    alert('Please Enter CVV1.');
                    return;
                }
                //CVV2
                if (newCard.CVV2 == null) {
                ...
                // NameOnCard
                if (newCard.NameOnCard == null) {
                    alert('Please enter name on Card.');
                    return;
                }
                // ReferenceId
                if (newCard.ReferenceId == null) {
                    alert('Please enter ReferenceId.');
                    return;
                }
                //CardStatus
                if (newCard.CardStatus == null) {
                    alert('Please select CardStatus.');
                    return;
                }
                //CustomerId
                ...
                //EstimatedStartDate
                if (newCard.EstimatedStartDate == null) {
                    alert('Please select EstimatedStartDate.');
                    return;
                }
                //EstimatedEndDate
                if (newCard.EstimatedEndDate == null) {
                    alert('Please select EstimatedEndDate.');
                    return;
                }
                //EffectiveFrom
                if (newCard.EfectiveFrom == null) {
                    alert('Please select data from EffectiveFrom.');
                    return;
                }
                //EffectiveFrom
                if (newCard.ValidTillDate == null) {
                    alert('Please select ValidTillDate or EffectiveTo date.');
                    return;
                }
               ...
               */
                ...
                var currCard = {
                    ...
                    CVV2: currCard.CVV2,
                    PIN: currCard.PIN,
                    CardStatus: currCard.StatusId.StatusId,
                    Customer: currCard.Customer.Customer,
                    UserId: currCard.UserId.UserId,
                    flag: 'I'
                }
