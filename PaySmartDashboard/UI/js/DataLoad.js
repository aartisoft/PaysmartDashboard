            ...
            case "9":
                ...
                function GetDrivers(data) {
                    ...
                    var list = {
                        ...
                        MobileNumber: data[2],
                        FleetOwner:data[3],
                        Address: (data[4].replace(/^\"/g, '').replace(/"$/g, '').replace(/\s/g, '')),
                        PermanentAddress: (data[5].replace(/^\"/g, '').replace(/"$/g, '').replace(/\s/g, '')),
                        Pin: (data[6].replace(/^\"/g, '').replace(/"$/g, '').replace(/\s/g, '')),
                        PermanentPin: (data[7].replace(/^\"/g, '').replace(/"$/g, '').replace(/\s/g, '')),
                        EmailId: data[8],
                        DriverCode: data[9],                        
